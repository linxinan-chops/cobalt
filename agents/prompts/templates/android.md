...
## Build TargetsIf building tests, `tools/autotest.py` should build the appropriate test on your
...
## Installing or Running an APK/BundleTo install or run an apk/bundle, use the generated wrapper script in
...
## JNIChrome on Android uses both Java and C++ frequently. Our JNI uses codegen from
